...
%%
%Everything we did earlier was simply logic regression. Now we will advance
%into neural networks

%Create a function called ForwardPropPredict
%function p = ForwardPropPredic(Theta1, Theta2, X)
