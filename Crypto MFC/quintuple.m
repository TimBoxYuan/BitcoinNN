...
X_Train_Raw = readtable('TrainData_5_2c.csv');
...
X_Test_Raw = readtable('TestData_5_2c.csv');
...
X_CV_Raw = readtable('CVData_5_2c.csv');
%Switch Data from table to Array for X
